...
cpu2015p.label = 'extrapolated'
disk2015p = biggles.Points([2015], disk2015, type='filled diamond',color='red')
disk2015p.label = 'extrapolated'

key=biggles.PlotKey(0.9,0.9,[cpup,cpu2015p,diskp,disk2015p], halign='right')

plt.add(cpup,cpu2015p,diskp,disk2015p,key)
plt.show()

print year
print diskcost,disk2015[0]
print cpucost,cpu2015[0]
