...
\vspace{3mm}
\noindent
{\bf Position Title of Principal Investigator:} Assistant Physicist
...
\vspace{3mm}
\noindent
{\bf Email of PI:} esheldon@bnl.gov
...
O(122) times the performance of a node purchased in 2010.   Also, we list
storage purchases per year but in practice storage may be bought in two or
three larger chunks.  Prices include bulk discounts from purchasing through the
RHIC Computing Facility at BNL, and storage, cooling, and maintenence
