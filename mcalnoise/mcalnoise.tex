...
\begin{table*}
    ...
    \caption{Description of the image simulations.  For the ``BD'' simulations,
        ...
        bad pixels, and other artifacts, drawn from DES imaging. For the RG
...
included an additional \nsimNStarTwo\ stellar objects, drawn simply as a PSF
with noise added.  The results are shown in table \ref{tab:results} for the
``Star'' type simulations.  We find that a stellar contamination of
\nsimNstarperc\ does not introduce any multiplicative significant bias, but
does increase the uncertainty by $\sim$5\%.  This is because stars have mean
response of zero, and also contribute zero to the shear in the absence
of additive errors.
...
\begin{figure}
    ...
    \caption{Distribution responses for galaxies and stars in
