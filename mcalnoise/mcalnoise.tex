...
This correction does not depend intimately on the model used, since it is only
the difference in response that is desired.  For consistency, we choose to use
the model that was used in the shear estimator, and we fit the generated model
images using the same model.
