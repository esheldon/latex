...
to element-wise division by a scalar.
...
Thus it is sufficient for shear-shear correlations to calculate the mean
response for the ensemble of objects.  This is a reflection of the assumption
that \probe\ is separable at zero shear: under this assumption, the
...
correlated shapes (see \S \ref{sec:IA}) or if there are imperfections
in image reduction and object identification (see \S \ref{sec:summary}).
