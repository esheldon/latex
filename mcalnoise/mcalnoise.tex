...
by the \psfex\ package \citep{BertinPSFEx2011}.  One may avoid this symmetrization procedure if one is
willing to also calculate the response of the estimator to a psf shear, as
demonstrated in \citep{HuffMcal}.
