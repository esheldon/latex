...
circular weight is used to avoid non-linear fitting issues.  The PDF of the
un-normalized moments is then symmetrized in order to infer an applied shear.
The accuracy in idealized simulations was found to be at the part in a thousand
level.  However, as this writing no formalism has been proposed to deal with
selection effects.
...
the accuracy fell just short of the part-in a thousand target.  However, given
its rigorous foundation, it may be the desired accuracy can be achieved with
further technical development.  The required prior information from deep data
should in principle be available to current and future surveys
