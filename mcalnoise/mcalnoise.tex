...
\begin{table*}
    ...
    \begin{tabular}{ | l | c | c | c | c | c | c | c | c | c |}
        ...
        RG           & COSMOS      & COSMOS       & Kolm./Optical & 3.40 + Optical  & Optical  & Optical  &  \nsimNgal   & None        & None      \\
    \end{tabular}
\end{table*}
...
\begin{table*}
    ...
    \begin{tabular}{ |l|  c|c|c|  c|c|c|}
        \hline
        & \multicolumn{3}{c}{\Mcal\ Uncorrected} & \multicolumn{3}{c}{\Mcal\ Corrected} \\
        %Sim         & $m$             & $c_1 \times 10^4$ & $c_2 \times 10^4$ & $m \times 10^{3}$ & $c_1 \times 10^4$ & $c_2 \times 10^4$ \\
