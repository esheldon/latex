...
challenging simulations and has performed more accurately.  On the other hand,
our current implementation of \Mcal\ has the limitation of adding extra noise
to deal with correlated noise effects.  This extra noise should not be
dominant for most shear correlation studies; nevertheless it is a priority 
going forward to develop a more precise correction.
