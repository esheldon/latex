...
\begin{align} \label{eq:Eexpand}
    \mest &= \mest|_{\gamma=0} + \gamma ~ \frac{ \partial \mest }{ \partial \gamma }\bigg|_{\gamma=0}  + ... \nonumber \\
...
\end{equation}
where $\mest^+$ is the measurement made on an image sheared by $+\gamma$,
$\mest^-$ is the measurement made on an image sheared by $-\gamma$,
...
image.  We can represent the series of operations on the observed image $I$ as
\begin{equation}
