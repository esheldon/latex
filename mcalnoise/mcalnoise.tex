...
of correlated noise errors.  The response when adding noise after \mcal\ does
...
measurement error
\begin{align}
    m_1 &= ( 2.4 \pm 2.3) \times 10^{-3} \nonumber \\
    m_2 &= ( 1.9 \pm 2.3) \times 10^{-3} \nonumber \\
    c_1 &= (-2.1 \pm 8.1) \times 10^{-5} \nonumber \\
    c_2 &= (-7.7 \pm 8.1) \times 10^{-5} \nonumber
\end{align}
