...
\end{align}
To leading order, we can write the multiplicative response of the ensemble as
\begin{align}
    \frac{\partial \langle E \rangle}{\partial \gamma} &= \int S(E) \frac{\partial  P(E) E  }{\partial \gamma} dE \nonumber \\
                      &= \int S(E) P(E) \frac{\partial E }{\partial \gamma} dE + \gamma \int S(E) E \frac{\partial P(E) }{\partial \gamma} dE \nonumber \\
                      &\approx \langle R \rangle + \int S(E) E \left( \frac{P(+\gamma) - P(-\gamma)}{\Delta \gamma}\right) dE  \nonumber \\
