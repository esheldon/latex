...
\end{align}
As noted in \S \ref{sec:mcal}, the off-diagonal elements of the response
matrix are usually negligible, and the diagonal elements equal.  In
this case we can form a simpler estimator for the 2-point function,
...
typically projected along different axes.
