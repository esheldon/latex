...
the expansion history and growth of structure can also be inferred  and thus
...
(XXX ref, e.g. Tyson 84).  In particular, because the effect is independent of
the dynamical state of the lensing mass, it can be used to study the
distribution of mass for any type of object, and on very large scales, much
larger than the typical regions over which systems can be said to be in
dynamical equilibrium \citep{Sheldon04,SheldonLensing09}.
