...
the assumptions these correction methods.  In \S \ref{sec:fixnoise} we explore a
simpler approach to correcting the noise.

\subsection{Adding a Sheared, Correlated Random Noise Field} \label{sec:fixnoise}

This method, which we refer to as ``\fixnoise'', is designed to statistically
cancel the effects correlated noise caused by the \mcal\ procedure.  For each
...
\begin{table*}
    ...
    \begin{tabular}{ |l|  r|r|r| |c|  r|r|r|}
        ...
        RG          & $0.12 \pm 0.00$ & $-0.3 \pm 0.3$    & $0.0 \pm 0.3$     & fixnoise & $0.5 \pm 0.6$     & $-0.4 \pm 0.3$    & $0.6 \pm 0.3$ \\
    \end{tabular}
\end{table*}
