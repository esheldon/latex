...
(XXX ref).  In particular, because the effect is independent of
the dynamical state of the lensing mass, it can be used to study the
distribution of mass on very large scales, much larger than the typical
regions over which systems can be said to be in dynamical equilibrium.
