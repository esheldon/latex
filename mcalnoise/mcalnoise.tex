...
is about $1.8 +/- 0.8$, somewhat smaller than the
log-normal $2.0 \pm 0.5$ for the parametric simulations, and with tails to larger
and smaller sizes.
...
\begin{figure}
    ...
    \caption{Distribution of S/N and half-light-radius in the COSMOS real galaxy simulations. The
    left panel contains the measured S/N, while the right panel contains
    the half-light-radius from the cosmos catalog for the input
    galaxies.  Overplotted in the dot-dashed line is the input half-light-radius
...
The most important difference between the GREAT3 sims and our sims is that
