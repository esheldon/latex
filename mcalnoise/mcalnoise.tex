...
a shorthand we will write this selection function as $S(E)$, the probability of
selecting an object with ellipticity $E$, although the selection may be
...
To leading order, we can write the multiplicative response of $\langle E \rangle$ 
...
selection based on the sheared parameters. The $\langle E \rangle^{S-}$
