...
\citep{fis00}, cluster of galaxies \citep{SheldonLensing09}, voids
\citep{MelchiorVoids2014}, and even without reference to known objects, the
so-called ``cosmic shear'' \citep{CFHTCosmicShear2013}.  Because the effect depends on the
geometry of the lens-source system, the expansion history can also be inferred
if the redshifts of the lensing material and sources are known, and thus weak
lensing is also sensitive to dark energy (XXX ref).  Lensing can also be used
to study dark energy through the grown of massive structures (XXX ref).
