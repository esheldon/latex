...
Assuming constant shear, , we wish to derive the response
of the estimator to a shear by taking the derivative about
zero shear (see \S \ref{sec:mcal}):
\begin{align}
...
discussed in section \ref{sec:mcal}, with selections based on the unsheared
