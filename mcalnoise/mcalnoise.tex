...
In real data, a selection may directly or indirectly select the redshift
of the sources, which means the true shear is will be different with
and without the selection.  This must be taken into account separately. We will
ignore this effect in what follows.
