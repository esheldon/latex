...
We propose to simulate the effects of the sheared, correlated noise on the
measured response.  We generate images with the right noise level for a given
galaxy, and then measure the response of this noise the convolutions and shears
used in \mcal.  We then subtract the mean sheared noise response from the mean
measured response, averaged over some set of galaxy images.
