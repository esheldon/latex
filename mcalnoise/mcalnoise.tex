...
bright blends mentioned above: unique objects must be identified and the
redshift distribution determined in order to properly interpret the shear
...
be partially suppressed because these objects have small shear response, but we
have not yet tested this.  Going forward, it is imperative to assess the
importance of this effect on both the shear response measurement and redshift
determination.  
