...
PSF (XXX ref), which requires a large number of parameters.  If the model
...
calibration based image simulations \citep[e.g.][]{Zuntz13,Miller13}.  These
...
accurate in for high \snr\ galaxy images, with little model bias
