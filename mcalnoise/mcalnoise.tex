...
Including \nsimNstarperc\ stars did noise the bias by about 5\%.  If the
...
could also be down-weighted using an appropriate weighting scheme, any
...
\ref{sec:bdsim}.  In these simulations, we masked ``bad'' pixels and columns,
