...
We tested the bias from this non-linearity using both the \bdsim\ image
...
For the toy model drew ellipticities from the distribution given in equation
...
depended on the type of simulation used, with values as large as 2.
...
model the it would be about 0.03.
