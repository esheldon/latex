...
If we assume the mean shear is zero over a large area of sky is small, the leading
...
\end{align}
where the next largest terms are of order $ \langle e_\alpha \rangle|_{\gamma=0} \cdot \gamma_\alpha^2$.
...
= P(e_\alpha)|_{\gamma=0} P(e_\beta)|_{\gamma=0}$.  Given this assumption, the following identities
also hold
\begin{align}
...
\end{align}
We can thus form a simple estimator for the 2-point function as:
\begin{align}
