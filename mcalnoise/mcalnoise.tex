...
the PSF has an optical and an atmospheric component.  The atmospheric component
is a Kolmogorov model with FWHM = 0.9 arscec, similar to GREAT3.  The optical
model introduces aberrations consistent with those found in the Dark Energy
Survey data \footnote{Aaron Roodman, private communication}.  The components
have variances shown in table \ref{tab:aberr}.

\begin{table*}
    \centering
    \caption{Variations for the aberrations in the optical model, derived
