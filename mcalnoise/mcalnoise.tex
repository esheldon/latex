...
Similarly, the $\langle \mest S^+ \rangle$ represents the mean of the unsheared
ellipticities, with selection based on the sheared parameters, and $\langle
\mest S^- \rangle$ represents the mean of the unsheared ellipticities, with
selection based on the negatively sheared parameters.

Thus in order to produce a mean shear measurement, one must measure the average
ellipticity $\langle e \rangle$, the mean shear response \mcalRgmean, and the
mean ellipticity selected based on positively sheared images $\langle e S^+
\rangle$ and negatively sheared images $\langle e S^- \rangle$.
