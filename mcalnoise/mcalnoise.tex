...
In this section we introduce the idea of \mcal. We will derive the
...
the Taylor expansion about zero shear gives
\begin{align}
    \langle e \rangle \approx \left< \gamma \frac{\partial e}{\partial \gamma} \bigg|_{\gamma=0} \right> \equiv \left< \gamma \mbox{\mcalR} \right>
\end{align}
...
Expanding the equation for the mean ellipticity, we find.
\begin{align}
...
= P(e_\alpha) P(e_\beta)$.  Given this assumption, the following identities
also hold
\begin{align}
...
\end{align}
We can thus form an estimator for the 2-point function as a weighted
average
\begin{align}
