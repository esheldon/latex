...
Note a similar idea was introduced by \cite{Kaiser2000}, which was in many ways
ahead of its time. Much of the treatment was quite general,  but the detailed
analysis focused on weighted second moment estimators.  The approach introduced
by \citep{HuffMcal} is intentionally agnostic about the underlying shear
estimator, with a focus on generic image manipulations efficiently performed on
current computers.
...
Finally, the \mcal\ procedure itself correlated the noise across the image,
