...
\begin{table*}
    ...
    the noise in the recovered shear by about $\sim$5\%.  \label{tab:results}}
    ...
    Sim & $m$ & $c_1 \times 10^4$ & $c_2 \times 10^4$ & $m \times 10^{4}$ & $c_1 \times 10^4$ & $c_2 \times 10^4$ \\
        ...
        BDMaskStar      & $0.1 \pm 0.0$ & $0.0 \pm 0.3$ & $-5.6 \pm 0.3$ & $(-8.1 \pm 5.0)\times 10^{-4}$ & $0.0 \pm 0.3$ & $1.3 \pm 0.3$  \\
