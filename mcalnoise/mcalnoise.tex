...
``ring configuration''.  The simulation included two identical images each
galaxy, rotated by 90 degrees with respect to a one another, in order to cancel
shape noise.  However, it is not clear to me that \mcalRnoise\ should cancel in
a ring configuration, unless the noise maps for the rotated galaxies were also
