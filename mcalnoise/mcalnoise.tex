...
the shear response.  We have assumed $E(\gamma=0)=0$ vanishes, but this may not
be the case in the presence of residual PSF anisotropy; we will address this
below.
...
PSF anisotropy, in the case that $E(\gamma=0)$ is not zero.  This correction involves shearing the PSF rather
than the galaxy:
\begin{equation}
...
\begin{equation}
    E =   \mbox{\mcalRpsf} e^{p} + \mbox{\mcalR} \gamma
\end{equation}
