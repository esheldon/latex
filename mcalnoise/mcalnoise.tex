...
the objects to measure detrending.  Table \ref{tab:subsets} shows the
...
Note, it is important to use a truly random subset of the population, including
whatever junk detections and stars contaminate the sample.  If a particular
measurement applies a selection, this selection must also be applied to the
random subset.
