...
\begin{align}
    \xi \approx \frac{1}{2!} \left< \frac{\partial^2 \xi}{\partial \gamma_\alpha \gamma_\beta} \gamma_\alpha \gamma_\beta \right>
\end{align}
...
\begin{align} \label{eq:twoptres1}
    \frac{1}{2} \frac{\partial^2 \xi}{\partial \gamma_\alpha \partial \gamma_\beta} =
        \frac{1}{2} \int d e_\alpha d e_\beta \biggl[ & \frac{\partial S_\alpha}{\partial \gamma_\alpha} \frac{\partial S_\beta}{\partial \gamma_\beta} P_{\alpha \beta} e_\alpha e_\beta  \nonumber \\
