...
represents the mean of the estimator with selection on the sheared parameters. The $\langle E
\rangle^-$ represents the mean after selection on the negatively sheared
parameters.  The
first term $\langle R \rangle$ is the normal \mcal\ response, averaged over the
unsheared distribution.  In practice, we can simply store the parameters used to
