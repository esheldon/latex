...
represents the mean of the estimator, with selection placed on the sheared parameters. The $\langle E
\rangle^-$ represents the mean with selection placed on the negatively sheared
parameters.  The
first term $\langle R \rangle$ is the normal \mcal\ response, with
selection placed on the unsheared distribution.  In practice, we can simply store the parameters used to
