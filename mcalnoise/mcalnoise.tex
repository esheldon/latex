...
The amplitude of the correlated noise effect, without shearing, is expected to
be at the few percent level for very small and faint sources
\citep{HirataCorrNoise}.  The sheared part, which is all that should remain in
