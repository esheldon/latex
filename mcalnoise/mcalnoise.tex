...
The PSF was an elliptical Moffat profile \citep{Moffat1969}, with \hlr\ = 1.5
pixels.  We drew the PSF shapes from a distribution designed to match that
measured in the Dark Energy Survey \citep[][(DES)]{DESSVShear}.  The DES PSF
shape distribution is well fit by a double Gaussian with width 0.18 in each
dimension, but with different mean for $e_1$ and $e_2$.  For the first set
of sims, ``BD'', we set the mean to $(0,0)$.  For the second set ``BDMask'',
we set the mean in $e_2$ to $0.007$, matching that in DES, but leave the
mean in $e_1$ zero in order to control for the effects of masking (see below).
...
\begin{table*}
    ...
    simulation shared the same galaxy images with the simulation of similar name, but with additional star
...
independent of those used in BD.   \label{tab:sims}}
    \begin{tabular}{ | l | c | c | c | c | c | c | c |}
        ...
        BDSN10     & Bulge+Disk   & Moffat    & \rpsfdist     &  \nsimNgal   & None        & None    & $(S/N) > 10$ \\
        BDSN15     & Bulge+Disk   & Moffat    & \rpsfdist     &  \nsimNgal   & None        & None    & $(S/N) > 15$ \\
        BDSN20     & Bulge+Disk   & Moffat    & \rpsfdist     &  \nsimNgal   & None        & None    & $(S/N) > 20$ \\
    \end{tabular}
\end{table*}
...
\begin{table*}
    ...
    bias by a factor of 5.  Image masking and stellar contamination have negligible
    effect on the recovered shear.  \label{tab:results}}
    \begin{tabular}{ | l    | r | r | r   | r | r | r |}
        ...
        \hline
        BD              & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$  \\
        BDStar          & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$  \\
        BDMask          & $1045 \pm 5.3$ & $0.0 \pm 0.3$ & $-5.6 \pm 0.3$ & $-7.6 \pm 4.9$ & $0.0 \pm 0.2$ & $1.2 \pm 0.2$  \\
        BDMaskStar      & $1045 \pm 5.3$ & $0.0 \pm 0.3$ & $-5.6 \pm 0.3$ & $-7.6 \pm 4.9$ & $0.0 \pm 0.2$ & $1.2 \pm 0.2$  \\
        BDSN10          & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$  \\
        BDSN15          & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$  \\
        BDSN20          & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$ & $xxx \pm xxx$  \\
    \end{tabular}
\end{table*}
% value is -0.02 for 
