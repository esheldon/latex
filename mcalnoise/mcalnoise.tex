...
\subsection{Remarks on Intrinsic Alignments}
...
alignments'' \citep[IA; for a recent review, see][]{TroxelIAReview2015}.  A
number of methods  have been proposed to correct for the contaminating effect
of IA in the shear \citep{TroxelIAReview2015}.  For \mcal, any correction
scheme must account for the effect of IA on the response calculations as well.
...
2-point functions.  Thanks for Paul Stankus for helpful comments on the draft.
