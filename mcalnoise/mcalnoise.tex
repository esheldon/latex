...
We found this method performed poorly using exponential and Gaussian models for
the galaxy.  We detected a remaining bias of  $m \sim 4 \times 10^{-3}$ in both
the \bdsim\ and \rgsim\ simulations.
