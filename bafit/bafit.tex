...
the smallest galaxies.  These small galaxies contribute little weight in the
average shear derived from samples defined by a \sn\ threshold TODO.  This
accuracy is sufficient for current and next-generation surveys.  The bias
occurs at a range of \sn, which may indicate the bias is a feature of my
likelihood sampling technique, and can potentially be improved upon.   
