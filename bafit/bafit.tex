...
the PSF, causing the flux could be underestimated.
...
It is probably worth while to further optimize the exploration of the
likelihood surface, both in terms of the number of steps used and the computing
resources used.  The problem is particularly amenable to use of graphics
processing units; a brief study showed an increase in speed of order 100
