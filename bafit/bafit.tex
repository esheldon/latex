...
flux parameter.  The size parameter is the sum of the variance in each
direction: $T=<x^2> + <y^2>$.  I used two distinct values of the index: $n=1$
...
to converge in three iterations even for shears of order 10\%, but note this
convergence will not succeed in the presense of large additive biases.
