...
at high shear.  On the other hand it is highly beneficial to work perform tests
...
of the shear.  For this reason I choose my expansion point to be the {\it true}
shear instead of zero.  In real data this will only be possible if the solution
can be iterated; one iteration would be sufficient.
...
\subsection{Calibration Bias vs. \sn and Size} \label{sec:snbias}
