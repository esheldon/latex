...
measurement.  Some kind of averaging must be performed to extract a shear from
galaxy shapes.  No information is necessarily ``lost'' by restricting shear
...
distribution of all the relevant galaxy parameters.  Note the prior on the shear
$P(\vecg)$ is assumed to be uninformative, and is treated as effectively
...
under shear, one can infer the applied shear, even in the presence of noise.
