...
order equations.  One possibility is iteration: in a case where the shear field
...
moments are interpreted using a Baysian formalism similar to that used for model
