...
images.  In addition, in collaboration with Mike Jarvis of UPenn, I am
continuing to test and tune the de-facto algorithm and pipeline for DES.  We
are strenuously testing these algorithms using simulations and will soon begin
testing on the commissioning data.
...
\ref{fig:getgdt}.  For \devprof\ galaxies a prior in the size distribution is
also required for unbiased shear measurements, as shown in the right panel
of figure \ref{fig:getgdt}.
