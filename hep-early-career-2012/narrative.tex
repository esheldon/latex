...
%This
%grant will fund a postdoc salary, my own salary (as required for laboratory
%employees) and purchase a moderate amount of computing.
...
computing.
%In addition, in collaboration with Mike Jarvis of UPenn, I am continuing to
%test and tune the de-facto algorithm and pipeline we have developed for DES.
...
%In section \ref{sec:shapelets} I describe the ``de-facto'' pipeline we have
...
The processing framework was implemented by myself.  This framework is
