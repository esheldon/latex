...
galaxies, each on 10 separate exposures, in this time of 2.5 weeks. In section
\ref{sec:gmix:gpu}, we showed that with two GPUs we got a factor of 28 speedup
compared to 12 CPU cores.  With these speedups we we would require only $\sim$
10 nodes, each with two GPUs, to reach our goal. 
