...
For the special case of Gaussians galaxy convolved by Gaussian PSF, the
...
orientations and noise properties.

We generate images with constant, weak shear of order 0.01.  We do not attempt
to recover spatially varying shear.

\subsection{Ring Tests}
