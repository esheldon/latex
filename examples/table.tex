...
%% To print this table by itself, uncomment the two lines below, as well
%% as the \end{document} command at the end of the file. 
%% Otherwise, use \input to insert the file into another
%% LaTeX document. See the end of the accompanying manuscript sample file, 
%% sample.tex, for an example of the \input command.
