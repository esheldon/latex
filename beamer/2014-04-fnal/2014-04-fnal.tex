...
\frame{
    ...
    \begin{itemize}
        ...
        \item Lensing has great potential for studying the geometry of
            the universe and the distribution of dark matter.

        \item Requirements are extremely stringent: 0.4\% and 0.2\% calibration
            on a 1\% signal for current and planned surveys.

        \item Calibration errors can come from incorrect distance estimation
            and incorrect shear estimation.
        ...
        \item Recent advances in Bayesian shear estimation are now known to be
            accurate enough (Sheldon 2014), but need an adequate, deep dataset
            to establish the population of galaxy shapes.
