...
\frame{
    ...
    \begin{itemize}
         ...
         \item Find a set of weights such that the distribution of observables
             ...
             weighted histograms will match as well, and that is an estimate
             of $N(z)$.
    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                ...
                \item A mockup of the SDSS samples shows the weighting method
                    works very well for lenses in the redshift range of
                    interest $\left[0.0, 0.3\right]$
...
\frame{
    ...
    \begin{itemize}
        ...
        \item My solution is to make lots of approximations:  use Gaussian
            ...
            Then the convolutions are fast and analytic. Use a fast exponential
            function, etc.
