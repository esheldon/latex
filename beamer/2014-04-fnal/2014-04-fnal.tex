...
\frame{
    ...
    \begin{itemize}
        ...
        \item Lensing has potential for studying the geometry of
            the universe and the distribution of dark matter.

        \item Requirements are stringent: 0.4\% and 0.2\% calibration on a 1\%
            signal for current and planned surveys.
