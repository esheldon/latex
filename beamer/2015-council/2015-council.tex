...

{
    ...
    {	
        ...
        \begin{center}
            %\includegraphics[trim=0 0 0 100,clip,width=0.85\textwidth]{DES0428-4748_gri-small.jpg}
            \includegraphics[scale=0.12]{DES0428-4748_gri-small.jpg}
            \newline
            \hfill {\tiny Part of the DES Survey, image E. Sheldon}
        \end{center}
...
\frame
{
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Type 1A Supernovae: Our best standard candles look too faint in the very distant past
            \item Baryon Acoustic Oscillations: Our best standard ruler looks too big in the recent past
        \end{itemize}
...

{
    ...
    \frame
    {
        ...
        \begin{center}
            ...
            {\tiny \hfill NGC 1398, E. Sheldon, M. Murphy}
        \end{center}
    }
...
\frame
{
    ...
    \begin{itemize}
        ...
        \item All studies used my lensing measurements, along with measurements
            from another group in DES, in friendly competition.
