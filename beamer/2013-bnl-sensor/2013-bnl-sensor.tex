...
\frame
{
    ...
    \begin{itemize}
        ...
        \item Sufficient accuracy for DES at \snflux$ > 10$.
    \end{itemize}
}
...
\frame
{
    ...
    \begin{itemize}
        ...
        \item Bias vs \snT\ even more universal. Sufficient accuracy for DES at \snflux$ > 10$.
        ...
        \item TODO: 
            ...
            \item Implement model-independent approach (Gary and Bob are on it).
...
\frame
{
    ...
    \begin{itemize}
        \item Assuming we can follow the right model.  Not true in real data.
            Should be OK for DES (Kacprzak et al. 2013) but not LSST.
        \item Bernstein \& Jarvis propose a model-independent technique using
            moments in Fourier space, but not yet implemented.
    \end{itemize}
}
\frame
{
