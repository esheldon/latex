    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}    
            \begin{itemize}
                ...
                \item Assuming equilibrium (good to order of magnitude) he calculated
...
\frame
{
    ...
    {\Huge Dark Matter Distribution in Galaxies}
...

{
    ...
    \frame
    {
        \frametitle{Mass-to-light Ratio: Light Should be More Concentrated}
                    ...
                    {\color{white}
                        ...
                        \item Cold Dark Matter confirmed
                            \begin{itemize} 
                                ...
                                \item Universal profile is a running power law, not
