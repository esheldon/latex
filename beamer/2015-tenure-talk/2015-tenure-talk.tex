...
\frame
{
    \frametitle{Important Detail: Shear Measurement}
...
\frame
{
    \frametitle{Important Detail: Ellipticity Measurement}
        ...
        \begin{columns}
            \begin{column}{0.5\textwidth}    
                \begin{itemize}
                    ...
                    \item About 100 times more mass than in bound region
...

{
    ...
    \frame
    {
        ...
        \begin{itemize}
            ...
            \item More useful than galaxies for constraining the dark matter profile
            \begin{itemize}
