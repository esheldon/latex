...
\frame
{
    ...
    \begin{columns}
        ...
        \end{column}
        \begin{column}{0.5\textwidth}    
            \includegraphics[width=\textwidth]{Telescope_Side_2-140.jpg}
            \newline
            \includegraphics[width=\textwidth]{LSST_Rendering_VK.jpg}
        \end{column}
    \end{columns}
}
...
\frame
{
    ...
    \begin{columns}
        ...
        \begin{column}{0.5\textwidth}    
            ...
            \newline
            \vspace{2mm}
            \includegraphics[width=\textwidth]{Group_photo-half.jpg}
            \newline
        ...
        \begin{column}{0.7\textwidth}
            \begin{itemize}
                    {\color{mygray}
                        ...
                        \item Techniques are now reaching maturity

                        \item Dark Matter is distributed smoothly throughout the
                            universe, not clumped together like the disspiative
                            baryonic material
