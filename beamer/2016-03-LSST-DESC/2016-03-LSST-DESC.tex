...
\author{Erin Sheldon}
\institute{Brookhaven National Laboratory\\LSST DESC Meeting}
...
\frame
{
    ...
    \begin{itemize}
        ...
        \item Parametric simulations with {\color{gold} 10\% stars}
             {\color{lightskyblue} 
                 \begin{eqnarray}
         ...
         \item Including stars introduces no additional bias: Stars have zero $R$.
