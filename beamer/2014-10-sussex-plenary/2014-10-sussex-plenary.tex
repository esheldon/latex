...
\frame
{
    ...
    \begin{columns}
        \begin{column}{0.4\textwidth}
            \begin{center}
                \includegraphics[width=\textwidth]{im3shape-e2-vs-e2psf.png}
                \newline
        ...
        \begin{column}{0.6\textwidth}
            \begin{center}
                \includegraphics[width=\textwidth]{ngmix009-e-vs-epsf.pdf}
                \newline
...
\frame
{
    ...
    Gravity only produces an E mode polarization (shapes are like polarizations).
