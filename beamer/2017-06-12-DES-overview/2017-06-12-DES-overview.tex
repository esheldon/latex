...
\frame
{
    ...
    \begin{itemize}
        ...
        \item In DES Y1 we have found that the mean response does not depend on
            separation between galaxies, so one need only calculate the mean
            response, even for 2-pt functions.
