...
\frame
{
    ...
    \frametitle{Cosmology with Optical Astronomy: Theory}
...
\frame
{
    ...
    \begin{itemize}
        ...
        \item Redshifting: {\color{gold} $z(|\Delta \vec{r}|)$}
...
\frame
{
    ...
    \frametitle{Cosmology with Optical Astronomy: Distance, Redshift and Density}
    ...
    \begin{itemize}
        ...
        \item Rather it can predict statistics about these quantities given
            the mean mass/energy density $\Omega$ for mass and dark energy
            ...
            \begin{itemize}
                ...
                \item {\color{gold} $\langle z(|\Delta \vec{r}|) \rangle$}: Averaged
                    over a large number of objects

                \item {\color{gold} $\langle \rho(\vec{r_1}) \rho(\vec{r_2})
                    \rangle$ }: Correlation function.  Also a function of time.
