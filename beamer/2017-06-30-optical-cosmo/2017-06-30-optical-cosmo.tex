...
\frame
{
    ...
    \begin{itemize}
        ...
        \item How the universe expands over time: how the distance between
            objects changes over time {\color{gold} $\mathrm{distance}(t)$ }
        ...
        \item How the matter within the universe reacts to gravity over time.
            ...
            in the universe evolves {\color{gold} $\mathrm{density}(\vec{r},t)$}
...
\frame
{
    ...
    \begin{itemize}
        ...
        \item Distance between
            objects over time: {\color{gold} $\mathrm{distance}(t)$ }

        \item Redshifting: {\color{gold} $z(\mathrm{distance})$}

        \item Density evolution: {\color{gold} $\mathrm{density}(\vec{r},t)$}
...
\frame
{
    ...
    \frametitle{Cosmology with Optical Astronomy: Distance and Redshift}
