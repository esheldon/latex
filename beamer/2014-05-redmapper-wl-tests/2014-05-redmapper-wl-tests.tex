...
\frame{
    ...
    \begin{itemize}
        ...
        \item SVA signal and consistency checks:
...
\frame{
    \frametitle{RedMapper Lensing}

    \fontsize{12}{1.5\baselineskip}

    \begin{itemize}

        \item Measure the properties of dark matter halos
        \item Dark matter -- baryon connection
        \item Cosmology: 
            \begin{itemize}
                \item Find clusters
                \item Abundance Function
                \item {\bf Mass calibration}
                \item Cluster clustering
            \end{itemize}

        \item Cluster mass calibration is a key part of cluster cosmology
    \end{itemize}
}
...
\frame{
    \frametitle{Comparison: RedMapper LRGs}
    \includegraphics[width=\textwidth]{binned-lrgdes01im3shape-r01-ilum-02-allplot.pdf}
}
    ...
    \begin{columns}
        \begin{column}{0.4\textwidth}
            \begin{itemize}
                ...
                \item Random point test will elucidate large-scale features.
            \end{itemize}
        \end{column}
