...
\frame
{
    ...
    \begin{itemize}
        ...
        \item Attempt to derive how the shear estimate (the shape) affected by
            ...
            first order approximation in shear.  Called the {\bf response} or
            sensitivity.
...
%            asymmetric and depends on galaxy properties and noise.
        ...
        \item No rigorous expression is given for the mean shear of a
            population given the mean ellipticity and responses.  Choose to
            simply average them separately and divide.
...
\frame
{
    ...
    \begin{itemize}
        ...
        \item I'm assuming I can find the right model.  Not true in real data.
            Should be OK for DES (Kacprzak et al. 2013) but perhaps not LSST.
