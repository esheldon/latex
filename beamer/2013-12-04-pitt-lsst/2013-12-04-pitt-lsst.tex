    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                ...
                \item Shear is weak, smaller than the shape noise, so we must
                    average the shear from many sources.  Look for correlations
                    in the shear field, or between shear and known objects
                    positions.
