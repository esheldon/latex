...
These are the fundamental new measurements we present in this work.
...
than $\nwei$.
We apply Eq. \ref{eqn:pzcorrect} to correct the \pofz s. 
...
\subsubsection{Correction to \pofz}
...
\ref{eqn:pzcorrect}.  This correction factor is shown in Figure \ref{fig:pzcorr}.
...
\begin{figure}[t]\centering
    ...
    correction to each of the \pofz\ in the release catalog.}
    \label{fig:pzcorr}
    \vspace{2em}
\end{figure}
...
\begin{figure}[t]\centering
    \includegraphics[{angle = -90,scale=0.5}]{figures/nz.sim.error.ps}
